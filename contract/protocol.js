...
class SampleProtocol extends Protocol{
    ...
    mapTxCommand(command){
        ...
        /tx --command '{"area":"contract_sync","readiness":"at_risk","note":"awaiting indexer warmup","op":"sync_readiness_pulse_sigmalogistikutama_collab_intercom"}' --sim 1
        ...
        */
        if(command === 'peek_readiness_pulse_sigmalogistikutama_collab_intercom'){
            obj.type = 'peekReadinessPulseSigmalogistikutamaCollabIntercom';
            obj.value = null;
            return obj;
            ...
            */
            ...
            if (json && typeof json === 'object' && json.op !== undefined) {
                if (json.op === 'sync_readiness_pulse_sigmalogistikutama_collab_intercom') {
                    obj.type = 'syncReadinessPulseSigmalogistikutamaCollabIntercom';
                    obj.value = json;
                    return obj;
                } else if (json.op === 'peek_readiness_pulse_sigmalogistikutama_collab_intercom') {
                    obj.type = 'peekReadinessPulseSigmalogistikutamaCollabIntercom';
                    obj.value = null;
                    return obj;
    ...
    async printOptions(){
        ...
        console.log('- /tx --command \'{"area":"contract_sync","readiness":"at_risk","note":"awaiting indexer warmup","op":"sync_readiness_pulse_sigmalogistikutama_collab_intercom"}\' | sync readiness pulse state.');
        console.log('- /tx --command "peek_readiness_pulse_sigmalogistikutama_collab_intercom" | read latest readiness pulse state.');
